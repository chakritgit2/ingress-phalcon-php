...
<form method="post" action="/ingress/store" class="max-w-md space-y-6">
    ...
    <div>
        <label class="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300">
            <input type="checkbox" name="login_bypass" value="1" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800">
            Login Bypass
        </label>
...
// conversion the renew dialog on index.volt already does.
(function () {
