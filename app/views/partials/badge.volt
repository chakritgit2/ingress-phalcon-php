...
<span class="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-600 ring-1 ring-inset ring-slate-500/10 dark:bg-slate-700/50 dark:text-slate-300 dark:ring-slate-600"><span class="h-1.5 w-1.5 rounded-full bg-slate-400"></span>ปิดชั่วคราว (นอกเวลาทำการ)</span>
{% else %}
