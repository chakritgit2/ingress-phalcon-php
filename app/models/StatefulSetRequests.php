...
class StatefulSetRequests extends Model
{
    public ?int $id = null;
    public string $public_id;
    public string $developer_name;
    public string $namespace;
    public string $statefulset_name;
    ...
    {
        $this->setSource('statefulset_requests');
        $this->belongsTo('created_by_user_id', Users::class, 'id', ['alias' => 'creator']);
        $this->hasMany('id', AuditLog::class, 'statefulset_request_id', ['alias' => 'auditEvents']);
        $this->hasMany('id', StatefulSetCommands::class, 'statefulset_request_id', ['alias' => 'commands']);
    }
